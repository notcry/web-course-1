<template>
<header class='flex bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 py-3 px-6 sm:px-10 font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
	<div class='flex flex-wrap items-center justify-between gap-4 w-full'>
		...
		<div id="collapseMenu"
			...
			<ul	class='lg:!flex lg:gap-x-6 max-lg:space-y-3 max-lg:fixed max-lg:bg-[#151d20] max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50 lg:justify-start'>
				...
				<li class='max-lg:border-b max-lg:py-3 px-3'>
					<a href='javascript:void(0)' class='text-gray-300 hover:text-white text-base flex items-center'>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511 511.999" fill="currentColor"
							class="w-4 h-4 mr-3">
							<path
